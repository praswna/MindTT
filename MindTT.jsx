...
const ALL_SERVES = [
  ...
  { label:'긴 하회전',   action:'SERVE_LONG_BACK',       color:'#1e40af', sub:'긴·하' },
  { label:'짧은 횡하',  action:'SERVE_SHORT_SIDE_BACK', color:'#1e40af', sub:'짧·횡하' },
  { label:'긴 횡하',    action:'SERVE_LONG_SIDE_BACK',  color:'#1e40af', sub:'긴·횡하' },
  { label:'짧은 상회전', action:'SERVE_SHORT_TOP',       color:'#9a3412', sub:'짧·상' },
  { label:'긴 상회전',   action:'SERVE_LONG_FAST',       color:'#9a3412', sub:'긴·상' },
  { label:'짧은 횡상',  action:'SERVE_SHORT_SIDE_TOP',  color:'#9a3412', sub:'짧·횡상' },
  { label:'긴 횡상',    action:'SERVE_LONG_SIDE_TOP',   color:'#9a3412', sub:'긴·횡상' },
  { label:'짧은 횡회전', action:'SERVE_SHORT_SIDE',      color:'#14532d', sub:'짧·횡' },
  { label:'긴 횡회전',   action:'SERVE_LONG_SIDE',       color:'#14532d', sub:'긴·횡' },
  { label:'짧은 너클',  action:'SERVE_KNUCKLE',          color:'#374151', sub:'짧·무' },
  { label:'긴 너클',    action:'SERVE_LONG_KNUCKLE',     color:'#374151', sub:'긴·무' },
];
